...
def order_m4(csv_path: Path = None, top_n: int = None) -> Counter:
    if csv_path is None:
        if len(sys.argv) > 1:
    ...
    # Build 4-row patterns vertically: for mega column (column 7, index 6), take values from 4 consecutive rows
