...
def order_m2(csv_path: Path = None, top_n: int = None) -> Counter:
    if csv_path is None:
        if len(sys.argv) > 1:
    ...
    # Build 2-row patterns vertically: for mega column (column 7, index 6), take values from 2 consecutive rows
